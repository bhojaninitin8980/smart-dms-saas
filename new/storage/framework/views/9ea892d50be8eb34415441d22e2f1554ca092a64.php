    ...
    <div class="codex-menuwrapper">
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <?php if(Gate::check('manage document') || Gate::check('manage my document') || Gate::check('manage reminder') || Gate::check('manage my reminder') || Gate::check('manage document history') || Gate::check('manage logged history') || Gate::check('manage support') || Gate::check('manage contact') || Gate::check('manage note')): ?>
                ...
                <?php if(Gate::check('manage support')): ?>
                    <li class="menu-item <?php echo e(in_array($routeName,['support.index','support.show'])?'active':''); ?>">
                        <a href="<?php echo e(route('support.index')); ?>">
                            <div class="icon-item"><i data-feather="headphones"></i></div>
                            <span><?php echo e(__('Supports')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
...
<!-- sidebar end-->
<?php /**PATH /var/www/html/product/dms/smart-dms-saas/new/resources/views/admin/menu.blade.php ENDPATH**/ ?>